    ...
    <div>
      ...
      <div className='px-[6%] my-10'>
        ...
        <div className='flex items-center justify-between'>
          ...
          <Button onClick={isApplied ? null : applyJobHandler} disabled={isApplied} className={`rounded-lg ${isApplied ? 'bg-gray-600 cursor-not-allowed' : 'bg-primary hover:bg-primary/90 cursor-pointer'} `}>
            {
